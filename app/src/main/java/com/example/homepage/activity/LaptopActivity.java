...
public class LaptopActivity extends AppCompatActivity {
    ...
    private void GetDataLaptop(final int order) {
                ...
                if (response != null){
                    ...
                    switch (order) {
                        case 0:
                            break;
                        case 1:
                            Collections.sort(listLaptop, Product.nameComparator); // name ascending
                            break;
                        case 2:
                            Collections.sort(listLaptop, Product.nameComparator.reversed()); // name descending
                            break;
                        case 3:
                            Collections.sort(listLaptop, Product.priceComparator); // price ascending
                            break;
                        case 4:
                            Collections.sort(listLaptop, Product.priceComparator.reversed()); // price descending
                            break;
                    }
                }
            }
